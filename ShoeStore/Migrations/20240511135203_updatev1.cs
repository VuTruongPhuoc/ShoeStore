        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoucherForAccs_Account_IdAccount",
                        column: x => x.IdAccount,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoucherForAccs_Voucher_IdVoucher",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    VoucherForAccId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_VoucherForAccs_VoucherForAccId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_VoucherForAccId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoucherForAccs_IdAccount",
                table: "VoucherForAccs",
                column: "IdAccount");

            migrationBuilder.CreateIndex(
                name: "IX_VoucherForAccs_IdVoucher",
                table: "VoucherForAccs",
                column: "IdVoucher");
